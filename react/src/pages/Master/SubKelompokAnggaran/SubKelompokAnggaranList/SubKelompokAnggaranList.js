...
const SubKelompokAnggaranList = ({setNavbarTitle}) => {
//TITLE
    const title = 'Jenis Anggaran'
//FAKE API
    const getSubKelompokAnggaranList = () => new Promise((resolve, reject) => {
        setTimeout(() => {
            resolve([
                {
                    id: 1,
                    kode: '01',
                    nama_sub_kelompok_anggaran: 'Energi',
                    nama_kelompok_anggaran: 'Rutin',
                    keterangan: 'Subkelompok Rutin - Energi',
                    checked: false
                },
                {
                    id: 2,
                    kode: '02',
                    nama_sub_kelompok_anggaran: 'Karyawan',
                    nama_kelompok_anggaran: 'Rutin',
                    keterangan: 'Subkelompok Rutin - Karyawan',
                    checked: false
                },
                {
                  id: 3,
                  kode: '03',
                  nama_sub_kelompok_anggaran: 'Pemeliharaan Aset',
                  nama_kelompok_anggaran: 'Rutin',
                  keterangan: 'Subkelompok Rutin - Pemeliharaan Aset',
                  checked: false
                },
                {
                  id: 4,
                  kode: '04',
                  nama_sub_kelompok_anggaran: '	Marketing',
                  nama_kelompok_anggaran: 'Non Rutin',
                  keterangan: 'Subkelompok Non Rutin - Marketing',
                  checked: false
                },
                {
                  id: 5,
                  kode: '05',
                  nama_sub_kelompok_anggaran: 'Persediaan',
                  nama_kelompok_anggaran: 'Non Rutin',
                  keterangan: 'Subkelompok Non Rutin - Persediaan',
                  checked: false
                },
                {
                    id: 6,
                    kode: '06',
                    nama_sub_kelompok_anggaran: 'Subkelompok Modal',
                    nama_kelompok_anggaran: 'Penyertaan Modal',
                    keterangan: 'Subkelompok Modal',
                    checked: false
                }
            ])
            reject(
...
//USE EFFECT
useEffect(() => {
    setNavbarTitle('Sub Kelompok Anggaran')
  }, [setNavbarTitle])
//DATA STATE
                            ...
                            reverse(data).map((datas, index) => {
                                return(
                                    <Tr key={index}>
                                        ...
                                        <Td>{datas.kode}</Td>
                                        <Td>{datas.nama_sub_kelompok_anggaran}</Td>
